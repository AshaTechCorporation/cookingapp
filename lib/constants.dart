...
Color background2 = Color(0xfff5f5f5);
...
List<Map<String, dynamic>> problemData = [
  {
    ...
    'title': 'คุณภาพของอาหารและการจัดส่ง',
    'options': [
      '- อาหารมาถึงล่าช้าหรืออุณหภูมิอาหารไม่เหมาะสม',
      '- อาหารที่จัดส่งไม่ตรงกับคำสั่งซื้อ (เมนูหรือส่วนประกอบผิดพลาด)',
      '- ความสะอาดและความสดของอาหารเมื่อจัดส่ง',
    ],
  },
  {
    'id': 2,
    'imagePath': 'assets/icons/byredcar.png',
    'title': 'ประสบการณ์การใช้งานแอปพลิเคชัน',
    'options': [
      '- ปัญหาในการสั่งอาหาร เช่น การสั่งไม่ได้ สั่งผิด หรือคำสั่งซื้อไม่ถูกบันทึก',
      '- แอปพลิเคชันทำงานช้า หรือมีข้อผิดพลาดขณะใช้งาน',
      '- ปัญหาในการชำระเงิน เช่น ไม่สามารถชำระเงินได้ หรือการชำระเงินผิดพลาด',
    ],
  },
  {
    'id': 3,
    'imagePath': 'assets/icons/byredcar.png',
    'title': 'บริการลูกค้าและการสนับสนุน',
    'options': [
      '- การตอบสนองจากทีมบริการลูกค้าล่าช้าหรือไม่เป็นมืออาชีพ',
      '- ปัญหาในการติดตามคำสั่งซื้อ เช่น ไม่สามารถติดตามสถานะการจัดส่งได้',
      '- การสื่อสารหรือการแก้ไขปัญหาไม่ตรงตามที่ลูกค้าคาดหวัง',
    ],
  },
];
